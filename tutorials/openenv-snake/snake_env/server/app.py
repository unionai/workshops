"""FastAPI app serving the Snake environment via OpenEnv protocol."""

import sys
import os

# Add parent dirs so snake_env is importable
...
async def startup():
    ...
    # Ensure snake_env package is importable (files land under /root/ in container)
    for candidate in [
